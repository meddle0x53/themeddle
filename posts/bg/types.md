...
Всички типове, които могат да имат стойности са от вида __*__.
Тип-конструктори с един аргумент са от вида __* -> *__. Подобно на функции!
Тип-конструктори с 2 аргумента са от вида __* -> * -> *__.
И така можем да продължим до безкрайност.

Забележете, че __* -> (* -> *)__, което всъщност е като  __* -> * -> *__ е различно от
__(* -> *) -> *__.
